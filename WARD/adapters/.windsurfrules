...
<!-- Generated from the compact runtime capsule (WARD/runtime.md). Do not edit directly. -->

# WARD — Runtime Adapter (compact)
...
> protocol adds `~201` words of active surface, not thousands.
