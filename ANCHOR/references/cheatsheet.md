...
| **Standard [CP-N]** | 10+ turns or 4+ items | `## Checkpoint [N]` + sections below |
...
|-------------|-----------------|
| `retry_bound_exceeded` | Recovery Discipline trigger (Failed transition). FUSE owns the finding; ANCHOR owns the recovery procedure. One merged block. |
