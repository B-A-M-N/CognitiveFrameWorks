...
def build_task_manifest(bundle: Any, *, session_id: str = "prestart",
    ...
    return {
        ...
        "namespace_id": bundle.pinned.get("namespace_id"),
        "application_id": bundle.pinned.get("application_id"),
        ...
        "routing_experiment_id": (bundle.guard_pack.get("routing_experiment") or {}).get("experiment_id"),
        "routing_experiment_plan": _thaw((bundle.guard_pack.get("routing_experiment") or {})),
        "routing_cohort": (bundle.guard_pack.get("routing_experiment") or {}).get("routing_cohort"),
        "candidate_profile_hash": (bundle.guard_pack.get("routing_experiment") or {}).get("candidate_profile_hash"),
        "candidate_adjustment_applied": (bundle.guard_pack.get("routing_experiment") or {}).get("candidate_adjustment_applied", False),
        "comparison_context_hash": (bundle.guard_pack.get("routing_experiment") or {}).get("comparison_context_hash"),
